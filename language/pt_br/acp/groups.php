...
$lang = array_merge($lang, array( 
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'O número máximo de destinatários permitido por mensagem privada. O valor máximo para todos os grupos do usuário é usado para determinar o valor real. <br /> Defina esse valor como 0 para substituir a configuração para todos os usuários deste grupo com a configuração de todo o phpBB.',
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Esta configuração substitui o limite da pasta de mensagens privadas por usuário. O valor máximo para todos os grupos do usuário é usado para determinar o valor real. <br /> Defina esse valor como 0 para substituir a configuração para todos os usuários deste grupo com a configuração de toda o phpBB.', 
