...
$lang = array_merge($lang, array( 
	...
	'tokens'	=>	array( 
		...
		'URL'			=> 'Uma URL válida utilizando qualquer protocolo permitido (http, ftp, etc… não pode ser utilizada para javascript). Se nenhum for concedido, "http://" é o prefixo padrão para a sequência.', 
		...
		'CHOICE'		=> 'Uma escolha de valores especificados, por exemplo <samp>{CHOICE=spades,hearts,diamonds,clubs}</samp>. Os valores são tratados como insensíveis a maiúsculas e minúsculas por padrão e podem ser tratados como sensíveis a maiúsculas e minúsculas especificando a opção <samp>caseSensitive</samp>: <samp>{CHOICE=Spades,Hearts,Diamonds,Clubs;caseSensitive}</samp>',
		'FLOAT'			=> 'Um valor decimal, por exemplo <samp>0.5</samp>.',
		'HASHMAP'		=> 'Mapeia strings de caracteres para sua substituição no formato <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>. Sensíveis a maiúsculas e minúsculas. Preserva valores desconhecidos por padrão.',
		'INT'			=> 'Um valor inteiro, por exemplo <samp>2</samp>.',
		'IP'			=> 'Um endereço de IPv4 ou IPv6 válido.',
		'IPPORT'		=> 'Um endereço de IPv4 ou IPv6 válido com número da porta.',
		'IPV4'			=> 'Um endereço de IPv4 válido',
		'IPV6'			=> 'Um endereço de IPv6 válido',
		'MAP'			=> 'Mapeia strings de caracteres para sua substituição no formato <samp>{MAP=string1:replacement1,string2:replacement2}</samp>. Insensíveis a maiúsculas e minúsculas. Preserva valores desconhecidos por padrão.',
		'RANGE'			=> 'Aceita um número inteiro no intervalo fornecido, por exemplo <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Valida seu valor em relação a uma determinada expressão regular (regexp), por exemplo <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		...
		'UINT'			=> 'Um valor inteiro sem sinal. Igual a <samp>{INT}</samp>, mas rejeita valores menores que 0.',
	),
)); 
