...
$lang = array_merge($lang, array( 
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> 'A sintaxe utilizada é idêntica à <a href="https://www.php.net/manual/datetime.format.php">função date</a> do PHP.', 
	...
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Mensagens não aprovadas podem ser visualizadas pelo autor. Não se aplica em mensagens de Visitantes.',
...
$lang = array_merge($lang, array( 
	...
	'MAX_POST_IMG_HEIGHT'			=> 'Altura máxima de arquivo flash por mensagem', 
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'Altura máxima de arquivos flash nas mensagens, sendo 0 igual a um valor ilimitado.', 
	'MAX_POST_IMG_WIDTH'			=> 'Largura máxima de arquivo flash por mensagem', 
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Largura máxima de arquivos flash nas mensagens, sendo 0 igual a um valor ilimitado.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Permitir autenticação HTTP significa permitir aos usuários acessar o conteúdo que está oculto aos visitantes, adicionando o parâmetro <samp>auth=http</samp> à URL do feed. Note que algumas configurações do PHP podem exigir mudanças adicionais no arquivo .htaccess; consulte esse arquivo para orientações. A autenticação HTTP só é suportada em conexões criptografadas (https).',
...
$lang = array_merge($lang, array( 
	...
	'ALLOW_CDN_EXPLAIN'				=> 'Se essa opção for ativada, alguns arquivos serão distribuídos pelos servidores externos em vez de seu servidor. Este recurso irá reduzir a largura de banda usada em seu servidor, mas pode apresentar questões de privacidade em alguns países. Em uma instalação padrão do phpBB, a livraria javascript “jQuery” e a fonte “Open Sans” são distribuídos pela rede de distribuição de conteúdo do Google. Também se aplica a fonte “Font Awesome”, na qual o phpBB e algumas extensões usam para rendenizar ícones.',
...
$lang = array_merge($lang, array( 
	...
	'SERVER_NAME_EXPLAIN'		=> 'O nome do domínio onde este fórum está executando (por exemplo: <samp>example.com</samp>).',
...
$lang = array_merge($lang, array( 
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Não forneça o protocolo (<samp>ssl://</samp> or <samp>tls://</samp>) a menos que seu servidor de e-mail solicite que você faça isso.',
