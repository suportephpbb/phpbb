...
$lang = array_merge($lang, array( 
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Permitir notificações do sistema',
)); 
...
$lang = array_merge($lang, array( 
	...
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Os usuários só podem publicar URLs sem esquema ou uma das listas separadas por vírgulas dos esquemas permitidos.',
...
$lang = array_merge($lang, array( 
	...
	'COOKIE_NOTICE_EXPLAIN'		=> 'Se ativado, um aviso de cookie será exibido aos usuários ao visitar seu phpBB. Isso pode ser exigido por regra, dependendo do conteúdo de seu phpBB e extensões habilitadas.',
...
$lang = array_merge($lang, array( 
    ...
    'FORM_TIME_MAX_EXPLAIN'         => 'O tempo que um usuário possui para submeter formas. Use -1 para desativar. Note que uma forma pode vir a ser inválida se a sessão expirar, mas isso não depende desta configuração.',
	...
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Se ativado, os certificados de uploads remotos serão validados. Isso requer que o pacote da CA seja definido pela configuração <samp>openssl.ca.file</ samp> ou <samp>curl.cainfo</ samp> em seu php.ini.',
)); 
...
$lang = array_merge($lang, array( 
	...
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Isso enviará um e-mail de teste para o endereço definido em sua conta.',
	...
	'TEST_EMAIL_SENT'				=> 'O e-mail de teste foi enviado.<br />Se você não o receber, verifique por favor sua configuração de e-mail.<br /><br />Se precisar de assistência, visite o <a href="https://www.phpbb.com/community/">fóruns de suporte do phpBB</a>.',
