...
$lang = array_merge($lang, array(
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'	=> 'Cada administrador pode permitir ou não os diversos tipo de anexos que desejar em seu painel. Se você não tem certeza sobre o que pode ser enviado, contate o administrador para maiores informações.', 
	...
	'HELP_FAQ_BLOCK_ATTACHMENTS'	=> 'Anexos',
	'HELP_FAQ_BLOCK_BOOKMARKS'	=> 'Assinaturas e marcadores',
	'HELP_FAQ_BLOCK_FORMATTING'	=> 'Formatar e tipos de tópicos',
	'HELP_FAQ_BLOCK_FRIENDS'	=> 'Amigos e inimigos',
	'HELP_FAQ_BLOCK_GROUPS'	=> 'Níveis de usuários e grupos',
	'HELP_FAQ_BLOCK_ISSUES'	=> 'Problemas do phpBB',
	'HELP_FAQ_BLOCK_LOGIN'	=> 'Problemas de login e registro',
	'HELP_FAQ_BLOCK_PMS'	=> 'Mensagens Privadas',
	'HELP_FAQ_BLOCK_POSTING'	=> 'Enviando problemas',
	'HELP_FAQ_BLOCK_SEARCH'	=> 'Pesquisando os Fóruns',
	'HELP_FAQ_BLOCK_USERSETTINGS'	=> 'Preferências do usuário e configurações',

	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> 'No phpBB 3.0, os tópicos de marcação de favoritos trabalharam muito como marcação de favoritos em um navegador da web. Você não foi alertado quando houve uma atualização. A partir do phpBB 3.1, marcação de favoritos é mais como assinar um tópico. Você pode ser notificado quando um tópico marcado é atualizado. Subscrever, entretanto, notificá-lo-á quando há uma atualização a um tópico ou a um fórum. A opções de notificação para favoritos e assinaturas podem ser configurados no Painel de Controle, em "Preferências". ',
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_QUESTION'	=> 'Qual é a diferença entre marcação e subscrição?',
	'HELP_FAQ_BOOKMARKS_FORUM_ANSWER'	=> 'Para inscrever em um fórum específico, clique no link "Subscrever fórum", na parte inferior da página, ao entrar no fórum.',
	'HELP_FAQ_BOOKMARKS_FORUM_QUESTION'	=> 'Como faço para me inscrever em fóruns específicos?',
	'HELP_FAQ_BOOKMARKS_REMOVE_ANSWER'	=> 'Para remover suas assinaturas, vá para o Painel de Controle do Usuário e siga os links para suas assinaturas.',
	'HELP_FAQ_BOOKMARKS_REMOVE_QUESTION'	=> 'Como faço para remover minhas assinaturas?',
	'HELP_FAQ_BOOKMARKS_TOPIC_ANSWER'	=> 'Você pode marcar ou assinar um tópico específico clicando no link apropriado no menu "Ferramentas do tópico", convenientemente localizado próximo à parte superior e inferior de uma discussão de tópico.<br />Responder a um tópico com a opção "Notificar-me quando tiver uma resposta" marcada também irá assinar o tópico.',
	'HELP_FAQ_BOOKMARKS_TOPIC_QUESTION'	=> 'Como faço para marcar ou assinar tópicos específicos?',
