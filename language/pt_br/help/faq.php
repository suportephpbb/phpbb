...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> 'O que a opção de “Excluir todos os cookies deste painel” faz?',
	...
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=> 'Compete ao administrador do fórum decidir se para poder criar mensagens, o registo é obrigatório. No entanto; o registo dá-lhe acesso a ferramentas adicionais não disponíveis aos visitantes, como imagens de avatar, mensagens privadas, e-mail de outros usuários, subscrição de grupos, etc. Leva apenas alguns minutos para registrar, então é recomendável que o faça.',
	...
	'HELP_FAQ_LOGIN_REGISTER_QUESTION'	=> 'Por que preciso registar-me?',
